...
public class ofertableTest {
    ...
    Promocion promo = new PromocionAbsoluta("Promocion De Prueba", 10.0);
    ...
    public void testGetCupoPromociones() {
        ...
        //se comprueba que las promociones devuelven el cupo de la Atraccion con menos cupo
        Promocion otraPromo = new PromocionAbsoluta("Promocion De Prueba", 10.0);
        Atraccion otraAtraccion = new Atraccion("Atraccion", 10.0, 10.0, TipoDeAtraccion.valueOf("ACCION"), 1);
    ...
    public void testOfertableTieneCupo() {
        ...
        Ofertable ofertaSinCupo = new Atraccion("Atraccion", 10.0, 10.0, TipoDeAtraccion.valueOf("ACCION"), 0);
    ...
    @Test
    public void testOfertableSerComprado() {
        for (Ofertable oferta : ofertas) {
            int cupoInicial = oferta.getCupo();
            oferta.serComprada();
            assertEquals(cupoInicial - 1, oferta.getCupo());
        }

        //Se agrega una oferta a la promocion para corroborar que disminuye el cupo de cada una
        Promocion otraPromo = new PromocionAbsoluta("Promocion De Prueba", 10.0);
        Atraccion otraAtraccion = new Atraccion("Atraccion", 10.0, 10.0, TipoDeAtraccion.valueOf("ACCION"), 1);
        ...
        otraPromo.serComprada();
        assertEquals(cupoInicial - 1, otraPromo.getAtracciones().get(0).getCupo());
        assertEquals(0, otraPromo.getAtracciones().get(1).getCupo());
    }
}
