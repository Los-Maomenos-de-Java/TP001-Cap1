...
public class ordenadorDeOfertasTest {
	...
	public void testOrdenadorDeOfertas() {
		...
		Promocion oferta1 = new PromocionPorcentual("Promocion De Prueba1",10.0);
		Atraccion oferta2 = new Atraccion("Atraccion De Prueba1", 20.0, 20.0, TipoDeAtraccion.valueOf("DEGUSTACION"), 10);
		oferta1.agregarAtraccion(oferta2);
		
		Promocion oferta3 = new PromocionPorcentual("Promocion De Prueba2",10.0);
		Atraccion oferta4 = new Atraccion("Atraccion De Prueba2", 200.0, 20.0, TipoDeAtraccion.valueOf("ACCION"), 10);
		oferta3.agregarAtraccion(oferta4);
		
		Atraccion oferta5 = new Atraccion("Atraccion De Prueba2", 20.0, 40.0, TipoDeAtraccion.valueOf("ACCION"), 10);
		Atraccion oferta6 = new Atraccion("Atraccion De Prueba2", 20.0, 20.0, TipoDeAtraccion.valueOf("ACCION"), 10);
